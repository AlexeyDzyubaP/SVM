...
def gaussian_kernel(x, y, sigma = 3):
...
C_ar = [0.05, 0.1, 0.5, 1.0, 5.0, 10.0, 50.0, 100.0]
kernel_ar = [linear_kernel, gaussian_kernel, poly_kernel]
sig = [1,2,3,4,5]
d = [2,3,4,5]
for ikern in range(3):
    for iC in range(8):
        ...
        if ikern == 1:
                    ...
                    model = SMOModel(X_train_scaled, y, C, kernel_ar[ikern], #gaussian_kernel,  # linear, poly, gaussian
                    ...
                    print('kernel, accuracy = ', ikern, accuracy)
